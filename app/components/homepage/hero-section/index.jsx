...
function HeroSection() {
  return (
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12 px-2 sm:px-4">
      <Image
        src="/hero.svg"
        alt="Hero"
        width={1572}
        height={795}
        className="absolute -top-[98px] -z-10 opacity-50 sm:opacity-100"
      />
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8 w-full max-w-7xl">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="my-8 sm:my-12 flex items-center justify-center sm:justify-start gap-3 sm:gap-5 flex-wrap">
            <Link
              href={personalData.github}
              target='_blank'
              className="transition-all text-pink-500 hover:scale-125 duration-300"
            >
              <BsGithub size={24} className="sm:w-[30px] sm:h-[30px]" />
            </Link>
            <Link
              ...
              className="transition-all text-pink-500 hover:scale-125 duration-300"
            >
              <BsLinkedin size={24} className="sm:w-[30px] sm:h-[30px]" />
            </Link>
            <Link
            ...
            <Link
              ...
              className="transition-all text-pink-500 hover:scale-125 duration-300"
            >
              <SiLeetcode size={24} className="sm:w-[30px] sm:h-[30px]" />
            </Link>
            <Link
              ...
              className="transition-all text-pink-500 hover:scale-125 duration-300"
            >
              <FaTwitterSquare size={24} className="sm:w-[30px] sm:h-[30px]" />
            </Link>
          </div>
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-3 sm:px-4 lg:px-8 py-3 sm:py-4 lg:py-8">
            <code className="font-mono text-xs sm:text-sm lg:text-base">
              <div className="blink">
                ...
                <span className="mr-1 sm:mr-2 text-pink-500">=</span>
              ...
              <div>
                <span className="ml-2 sm:ml-4 lg:ml-8 mr-1 sm:mr-2 text-white">hardWorker:</span>
                <span className="text-orange-400">true</span>
                <span className="text-gray-400">,</span>
              </div>
              <div>
                <span className="ml-2 sm:ml-4 lg:ml-8 mr-1 sm:mr-2 text-white">quickLearner:</span>
                <span className="text-orange-400">true</span>
                <span className="text-gray-400">,</span>
              </div>
              <div>
                <span className="ml-2 sm:ml-4 lg:ml-8 mr-1 sm:mr-2 text-white">problemSolver:</span>
                <span className="text-orange-400">true</span>
                <span className="text-gray-400">,</span>
              </div>
              <div>
                <span className="ml-2 sm:ml-4 lg:ml-8 mr-1 sm:mr-2 text-green-400">hireable:</span>
                <span className="text-orange-400">function</span>
                <span className="text-gray-400">{'() {'}</span>
              </div>
              <div>
                <span className="ml-4 sm:ml-8 lg:ml-16 mr-1 sm:mr-2 text-orange-400">return</span>
                <span className="text-gray-400">{`(`}</span>
              </div>
              <div>
                <span className="ml-6 sm:ml-12 lg:ml-24 text-cyan-400">this.</span>
                <span className="mr-1 sm:mr-2 text-white">hardWorker</span>
                <span className="text-amber-300">&amp;&amp;</span>
              </div>
              <div>
                <span className="ml-6 sm:ml-12 lg:ml-24 text-cyan-400">this.</span>
                <span className="mr-1 sm:mr-2 text-white">problemSolver</span>
                <span className="text-amber-300">&amp;&amp;</span>
              </div>
              <div>
                <span className="ml-6 sm:ml-12 lg:ml-24 text-cyan-400">this.</span>
                <span className="mr-1 sm:mr-2 text-white">skills.length</span>
                <span className="mr-1 sm:mr-2 text-amber-300">&gt;=</span>
                <span className="text-orange-400">5</span>
              </div>
              <div><span className="ml-4 sm:ml-8 lg:ml-16 mr-1 sm:mr-2 text-gray-400">{`);`}</span></div>
